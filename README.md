...
<body class="bg-gray-50 text-gray-900">
  ...
  <div id="subscribe-modal" class="fixed inset-0 bg-black/70 hidden z-50 flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6 text-center">
      ...
      <div id="download-area" class="hidden mt-4">
        ...
        <a id="download-link" href="https://www.mediafire.com/file/ksejix8ct23he32/PANEL.ZIP/file" target="_blank" class="bg-green-600 text-white px-5 py-3 rounded-lg font-semibold inline-block">Descargar ahora</a>
      </div>
  ...
  <script>
    ...
    const VIDEO_URL    = "https://youtu.be/4sGDro26eIc?si=cz5ZgknbKmT2oa01";
